    ...
    if (os.path.isdir(parent_dir)):
        ...
        for dir in dirs:
            ...
            for image in images:
                ...
                print(f'magick split...\n')
                os.system(f'magick {parent_dir}/{dir}/{image} -crop 50%x100% +repage {split_dir}/{image}_%02d.jpg')
                print(f'merge ...')
                os.system(f'magick convert +append "{split_dir}/{image}_01.jpg" "{split_dir}/{image}_00.jpg" "{result_dir}/{image}"')
                print(f'copy exif...\n')
                os.system(f'exiftool -TagsFromFile -overwrite_original_in_place {parent_dir}/{dir}/{image} {result_dir}/{image} ')
